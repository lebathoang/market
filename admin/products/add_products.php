            ...
            <div class="content-wrapper">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    <table>
                        ...
                        <tr>
                            <td>Enter image</td>
                            <td><input type="text" name="image_product"></td>
                        </tr>
                        <tr>
                            <td>Enter price</td>
                        ...
                        <tr>
                            <td><input class="btn btn-primary btn-sm" type="submit" value="add" name="save"></td>
                        </tr>
                    </table>
                </form>
            </div>
...
if (isset($_POST['save'])) {
    try {
        $sql = "INSERT INTO products(`name`, `image`,`price`, `quantity`, `decription`, `type`, `classify`, `sale`) VALUES (:name, :image, :price, :quantity, :decription, :type, :classify, :sale)";
